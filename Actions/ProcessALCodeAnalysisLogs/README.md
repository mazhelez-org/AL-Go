...
The default folder location can be overridden with the errorLogsFolder param.
...
| errorLogsFolder | | Folder containing error logs downloaded in a previous step and which will contain the sarif output json file | ErrorLogs |
